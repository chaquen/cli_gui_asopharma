select CONCAT(pro.codigo_producto,pro.codigo_distribuidor,"'",pro.nombre_producto,"','",pro.tipo_venta_producto,"','",tipo_presentacion,"','",dt.cantidad_existencias,"','",dt.cantidad_existencias_blister,"','",dt.cantidad_existencias_unidades) from productos pro 
